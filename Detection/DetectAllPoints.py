...
def getMatrixFromImage(img):
    ...
    img = img_orig.resize((img_width,img_height), resample=Image.BILINEAR)
    img_rgb = img
    ...
    if M is not None:
        ...
        # file_save = file_to_save + '/'+str(count_pic)+'.jpg'
        # print('filetest', file_save)
...
# file2 = 'D:\Year4_2\module89\AI detection\Detect_chessBoard\chessApp\data1.jpg'
# file = 'D:\Year4_2\module89\AI detection\Detect_chessBoard\chessApp\data1.jpg'
# img = cv2.imread(file)
# print(bytearray(img))
# clear_image, encoded_image, matrix = getMatrixFromImage(img)
# print('matrix', len(matrix))
# cv2.imshow('clear', clear_image)
# cv2.imshow(' encoded', encoded_image)

# file = 'D:/Year4_2/module89/AI detection/Detect_chessBoard/chessApp/dataset'
# file_to_save = 'D:/Year4_2/module89/AI detection/Detect_chessBoard/chessApp/result'
# all_image, filename_all = df.load_all_images(file)
# count = 0
# for image in all_image:
#     print(filename_all[count])
#     getMatrixFromImage(image, count, file_to_save)
#     count += 1
# cv2.waitKey(0)
# cv2.destroyAllWindows()
